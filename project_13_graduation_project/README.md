...
## 1. [Проект в сфере e-commerce + презентация + дашборд](README.md#1-Проект-по-А/B---тестированию)  
## 2. [Проект по А/B-тестированию](README.md#2-e-commerce---выявление-профилей-потребления)
